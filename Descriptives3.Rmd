...
```{r average years of study by FB, message=FALSE, warning=FALSE}
library(psych)
...
```{r average years x Whatsapp, message=FALSE, warning=FALSE}
library(dplyr)
whatxedad <- lapop18 %>%
...
```{r weighted mean age and studies}
