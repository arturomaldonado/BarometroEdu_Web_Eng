...
This data has to be concatenated.
For this reason, the function `c(…)` appears before this series of numbers.
...
In a similar way, we can create a vector with the names (or acronyms) of all countries, in quotation marks and within the function `c(…)`.
